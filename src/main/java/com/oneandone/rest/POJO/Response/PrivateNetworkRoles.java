 ...
 * @author Ali
 */
public class PrivateNetworkRoles {
    ...
    private Boolean setNetworkInfo;
    ...
    /**
     *
     * @return The setNetworkInfo
     */
    @JsonProperty("set_network_info")
    public Boolean getSetNetworkInfo() {
        return setNetworkInfo;
    }

    /**
     *
     * @param setNetworkInfo The set_network_info
     */
    @JsonProperty("set_network_info")
    public void setSetNetworkInfo(Boolean setNetworkInfo) {
        this.setNetworkInfo = setNetworkInfo;
    }
