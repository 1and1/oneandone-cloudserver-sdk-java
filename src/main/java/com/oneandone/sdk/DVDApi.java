 ...
 * @author aliba
 */
public class DVDApi extends OneAndOneAPIBase {
     ...
     * @return List DVDResponse
     * @throws RestClientException
     * @throws IOException
     */
    public List<DVDResponse> getDVDs(int page, int perPage, String sort, String query, String fields) throws RestClientException, IOException {
        ...
        DVDResponse[] result = client.get(queryUrl, null, DVDResponse[].class);
        return Arrays.asList(result);
    }

    /**
     * Information about specific ISO image
     * @param dvdId Iso's ID
     * @return DVDResponse
     * @throws RestClientException
     * @throws IOException
     */
    public DVDResponse getDVD(String dvdId) throws RestClientException, IOException {
        return client.get(getUrlBase().concat(resource).concat("/").concat(dvdId), null, DVDResponse.class);
    }
