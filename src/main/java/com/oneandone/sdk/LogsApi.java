 ...
 * @author aliba
 */
public class LogsApi extends OneAndOneAPIBase {
     ...
     * @throws IOException
     */
    public List<LogResponse> getLogsCustomPeriod(int page, int perPage, String sort, String query, String fields, Date start_date, Date end_date) throws RestClientException, IOException {
        ...
        return Arrays.asList(client.get(queryUrl, null, LogResponse[].class));
    }
     ...
     * @throws IOException
     */
    public List<LogResponse> getLogs(int page, int perPage, String sort, String query, String fields, Types.PeriodType period) throws RestClientException, IOException {
        String queryUrl = getUrlBase().concat(resource).concat("?");
     ...
     * @param logId Unique monitoring policy's identifier.
     * @return LogResponse
     * @throws RestClientException
     * @throws IOException
     */
    public LogResponse getLog(String logId) throws RestClientException, IOException {
        return client.get(getUrlBase().concat(resource).concat("/").concat(logId), null, LogResponse.class);
    }
