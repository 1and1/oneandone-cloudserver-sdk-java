 ...
 * @author aliba
 */
public class MonitoringPoliciesApi extends OneAndOneAPIBase {

    public MonitoringPoliciesApi() {
        super("monitoring_policies", "");
    }
     ...
     * @throws IOException
     */
    public List<MonitoringPoliciesResponse> getMonitoringPolicies(int page, int perPage, String sort, String query, String fields) throws RestClientException, IOException {
        ...
        MonitoringPoliciesResponse[] result = client.get(queryUrl, null, MonitoringPoliciesResponse[].class);
     ...
     * @throws IOException
     */
    public MonitoringPoliciesResponse getMonitoringPolicy(String policyId) throws RestClientException, IOException {
        return client.get(getUrlBase().concat(resource).concat("/").concat(policyId), null, MonitoringPoliciesResponse.class);
    }

    /**
     * Creates a new monitoring policy.
     * @param object CreateMonitoringPolictRequest
     * @return MonitoringPoliciesResponse
     * @throws RestClientException
     * @throws IOException
     ...
     */
    public MonitoringPoliciesResponse createMonitoringPolicy(CreateMonitoringPolictRequest object) throws RestClientException, IOException {
        return client.create(getUrlBase().concat(resource), object, MonitoringPoliciesResponse.class, 201);
    }
     ...
     * @throws IOException
     */
    public MonitoringPoliciesResponse deleteMonitoringPolicy(String policyId) throws RestClientException, IOException {
        return client.delete(getUrlBase().concat(resource).concat("/").concat(policyId), MonitoringPoliciesResponse.class);
    }

    /**
     * Modifies a monitoring policy.
     * @param policyId Unique monitoring policy's identifier.
     * @param object UpdateMonitoringPolicyRequest
     * @return MonitoringPoliciesResponse
     * @throws RestClientException
     * @throws IOException
     */
    public MonitoringPoliciesResponse updateMonitoringPolicy(String policyId, UpdateMonitoringPolicyRequest object) throws RestClientException, IOException {
        return client.update(getUrlBase().concat(resource).concat("/").concat(policyId), object, MonitoringPoliciesResponse.class, 202);
    }
}
