...
public class RecoveryAppliancesTest {
    ...
    static List<RecoveryAppliancesResponse> appliances;

    @BeforeClass
    public static void getRecoveryAppliances() throws RestClientException, IOException {
        oneandoneApi.setToken(System.getenv("OAO_TOKEN"));
        List<RecoveryAppliancesResponse> result = oneandoneApi.getRecoveryAppliancesApi().getRecoveryAppliances(0, 0, null, null, null);
        appliances = result;
