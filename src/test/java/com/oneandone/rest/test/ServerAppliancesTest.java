...
public class ServerAppliancesTest {
    ...
    static List<ServerAppliancesResponse> appliances;
    ...
    public void getServerAppliance() throws RestClientException, IOException {
        ServerAppliancesExtendedResponse result = oneandoneApi.getServerAppliancesApi().getServerAppliance(appliances.get(0).getId());
